CREATE TABLE IF NOT EXISTS `product_sku` (
    ...
    `spu_name` varchar(255) DEFAULT NULL COMMENT '商品 SPU 名字',
    `properties` varchar(1024) DEFAULT NULL COMMENT '规格值数组-json格式， [{propertId: , valueId: }, {propertId: , valueId: }]',
...
CREATE TABLE IF NOT EXISTS `product_brand` (
    ...
    `pic_url` varchar(255) DEFAULT NULL COMMENT '品牌图片',
    `sort` int NOT NULL DEFAULT '0' COMMENT '排序字段',
